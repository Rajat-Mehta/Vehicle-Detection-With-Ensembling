...
"""
This script can be used to train Faster R-CNN model on our vehicle dataset end-to-end.
...
Reference: https://gluon-cv.mxnet.io/build/examples_detection/train_faster_rcnn_voc.html
"""
...
def parse_args():
    ...
    parser.add_argument('--save-prefix', type=str, default='./train_logs/frcnn/',
...
if __name__ == '__main__':
    ...
    print(ctx)
    args.batch_size = 8
    train_dataset = gcv.data.RecordFileDetection('../data_set_files/record_format_files/data-set_min/train.rec')
    val_dataset = gcv.data.RecordFileDetection('../data_set_files/record_format_files/data-set_min/val.rec')
    classes = ['car','articulated_truck','bus','bicycle','motorcycle','motorized_vehicle','pedestrian','single_unit_truck','work_van','pickup_truck','non-motorized_vehicle']  # only one foreground class here
    ...
    train_data, val_data = get_dataloader(
        net, train_dataset, val_dataset, args.batch_size, 0)
