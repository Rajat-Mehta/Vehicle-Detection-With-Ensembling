...
"""
This script can be used to train Faster R-CNN model on our filtered dataset end-to-end.
All of the dataset paths have been configured in the arguments. You can start training by running this command:
python filtered_finetune_fr_cnn.py
...
def parse_args():
    ...
    parser.add_argument('--save-prefix', type=str, default='./train_logs/filtered_frcnn/',
...
if __name__ == '__main__':
    ...
    print(ctx)
    args.batch_size = 8
    train_dataset = gcv.data.RecordFileDetection('../data_set_files/record_format_files/filtered_data_set/train.rec')
